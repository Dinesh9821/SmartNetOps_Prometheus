...
(function () {
  ...
  var THEME_KEY = 'smartNetOpsTheme';
  ...
  function savedTheme() {
    try { return validTheme(localStorage.getItem(THEME_KEY)); }
  ...
  function updateThemeControls(theme) {
    document.querySelectorAll('[data-theme-toggle]').forEach(function (control) {
      ...
      var state = control.querySelector('[data-theme-state]');
  ...
  // Apply before the body is parsed so every page starts in the saved theme.
  ...
  var ROUTES = [
    ...
    { id: 'server-global.html',      icon: '▤', name: 'Server',             hint: 'Global',   crumb: 'Server' },
    { id: 'network-global.html',     icon: '⬡', name: 'Network',            hint: 'Global',   crumb: 'Network' },
    { id: 'cloud-global.html',       icon: '◌', name: 'Cloud',              hint: 'Global',   crumb: 'Cloud' },
  ...
  function bindThemeControls() {
    updateThemeControls(root.getAttribute('data-theme'));
    document.querySelectorAll('[data-theme-toggle]').forEach(function (control) {
      if (control.dataset.themeBound) return;
  ...
  window.NetOps = {
    toast: toast, go: go, palette: openPalette, counters: counters,
    getTheme: function () { return root.getAttribute('data-theme'); },
    setTheme: function (theme) { return applyTheme(theme, true); },
